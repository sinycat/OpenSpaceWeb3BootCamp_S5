...
// constructor带参数
contract BaseERC721 is Ownable {
    ...
    function safeTransferFrom(
        ...
        _safeTransfer(from, to, tokenId, ""); // 直接调用 _safeTransfer
    }

    /**
     * @dev safeTransferFrom 应该是外部调用
     */
...
// 继承 BaseERC721 合约创建可用于铸造与交易 NFT 的合约
contract MyERC721NFT is BaseERC721 {
    constructor(
        string memory name_,
        string memory symbol_,
        string memory baseURI_
    ) BaseERC721(name_, symbol_, baseURI_) {}
